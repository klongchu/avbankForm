	...
	<div class="m-grid m-grid--hor m-grid--root m-page">
		...
		<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
			...
			<div class="m-login__signin">
			    ...
			    <form class="m-login__form m-form" action="<?= base_url('login/validlogin'); ?>" method="post" onsubmit="return check_login();">
				<div class="form-group m-form__group">
				    <input class="form-control m-input"   type="text" placeholder="Username" name="s_username" id="s_username" autocomplete="off">
				</div>
				<div class="form-group m-form__group">
				    <input class="form-control m-input m-login__form-input--last" type="password" placeholder="Password" name="s_password" id="s_password">
				</div>
				<div class="form-group m-form__group">
				    <br />
				...
				<div class="form-group m-form__group">
				    <input class="form-control m-input m-login__form-input--last" type="text" placeholder="Captcha" id="txt_captcha"  name="captcha" />
				</div>
				<div class="row m-login__form-sub" style="display:none;">
				...
				<div class="m-login__form-action">
				    <button style="cursor: pointer;" disabled="disabled" id="btn_login" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary">
					Sign In
				    </button>
				</div>
			    </form>
