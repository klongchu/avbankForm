...
<script src="<?php echo base_url(); ?>assets/app/js/common.js" type="text/javascript"></script>
<!-- Main -->
<!-- Follow Pages -->
<?php
...
?>
<script src="<?php echo base_url(); ?>assets/app/js/bank.js" type="text/javascript"></script>
<?php  
}
