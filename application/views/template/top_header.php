        ...
        <div class="m-stack m-stack--ver m-stack--desktop  m-header__wrapper">
            ...
            <div class="m-stack__item m-stack__item--middle m-stack__item--center">
                ...
                <a href="<?= base_url(); ?>" class="m-brand m-brand--desktop">
                    <img alt="" src="<?= base_url(); ?>assetsXI/demo/demo9/media/img/logo/logo.png"/>
                </a>
                <!-- END: Brand -->
            </div>
                            ...
                            <li class="m-nav__item m-dropdown m-dropdown--medium m-dropdown--arrow  m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
                                <a href="#" class="m-nav__link m-dropdown__toggle">
                                    ...
                                    <span class="m-topbar__userpic">
                                        <img src="<?= base_url(); ?>assetsXI/app/media/img/users/user4.jpg" class="m--img-rounded m--marginless m--img-centered" alt=""/>
                                    </span>
                                        ...
                                        <div class="m-dropdown__header m--align-center">
                                            <div class="m-card-user m-card-user--skin-light">
                                                <div class="m-card-user__pic">
                                                    <img src="assetsXI/app/media/img/users/user4.jpg" class="m--img-rounded m--marginless" alt=""/>
                                                </div>
